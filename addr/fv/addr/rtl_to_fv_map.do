...
# Generated on: Fri Jan 23 10:33:20 IST 2026 (Fri Jan 23 05:03:20 UTC 2026)
...
set logfile fv/addr/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/addr -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  addr.v
elaborate_design -golden -root {addr} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/addr/fv_map.v.gz
elaborate_design -revised -root {addr}
...
set_system_mode lec
write_compared_points noneq.compared_points.addr.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.addr.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.addr.rtl.fv_map.rpt
